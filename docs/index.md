---
layout: default
title: Tiation Fantasy Premier League - Enterprise Solution
...
<div class="tiation-hero">
  ...
  <div class="hero-content">
    ...
    <h1 class="hero-title">
      ...
      <span class="gradient-text">Tiation Fantasy Premier League</span>
    </h1>
    ...
    <div class="hero-cta">
      ...
      <a href="https://github.com/tiation/tiation-fantasy-premier-league" class="btn-tertiary">📁 View Code</a>
    </div>
  </div>
</div>
...
```bash
# Build Docker image
docker build -t tiation-fantasy-premier-league .

# Run container
docker run -p 8080:8080 tiation-fantasy-premier-league
```
...
### 📞 Getting Help
- **📚 Documentation**: [Full documentation](https://tiation.github.io/tiation-fantasy-premier-league)
- **❓ FAQ**: [Frequently asked questions](faq.md)
- **🐛 Issues**: [GitHub Issues](https://github.com/tiation/tiation-fantasy-premier-league/issues)
- **💬 Discussions**: [GitHub Discussions](https://github.com/tiation/tiation-fantasy-premier-league/discussions)
